...
<template>
  <div
    class="page-banner"
    style="
      --banner: url(&quot;https://cmsassets.rgpub.io/sanity/images/dsfx7636/news_live/91a720561b6cd9c649a9148782f34d96e78cd894-4320x2430.jpg?auto=format&w=1600&quot;);
    "
  >
    <div class="wrap">
        ...
        <div style="display: flex; gap: 18px; align-items: center; flex-wrap: wrap">
          <div style="flex: 1; min-width: 240px">
            ...
            <p class="muted mono" style="font-size: 0.74rem; margin-top: 4px">
              ...
              {{ deck.format === "tournament" ? "tournoi" : "libre" }} · validation {{ okCount(deck) }}/{{
                deck.checks.length
              }}
            </p>
            ...
            <p class="muted" style="font-size: 0.9rem; margin-top: 8px" v-if="deck.description">
              {{ deck.description }}
            </p>
          </div>
          <button
